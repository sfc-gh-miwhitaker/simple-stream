...
-- ============================================================================
SELECT 
    'sfe_badge_events_stream' AS stream_name,
    SYSTEM$STREAM_HAS_DATA('RAW_INGESTION.sfe_badge_events_stream') AS has_data;
